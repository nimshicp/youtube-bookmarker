    ...
    <div className="min-h-screen bg-neutral-950 text-white p-8 relative overflow-hidden">
      ...
      <main className="max-w-7xl mx-auto relative z-10 flex flex-col items-center">
        <div className="w-full max-w-3xl flex flex-col items-center mb-16">
          <h1 className="text-5xl font-extrabold tracking-tight mb-8 bg-gradient-to-r from-white via-neutral-200 to-neutral-400 bg-clip-text text-transparent text-center">
            Find and Save Videos
          </h1>
          
          <div className="w-full relative group">
            <div className="absolute inset-y-0 left-0 pl-6 flex items-center pointer-events-none">
              <svg className="h-6 w-6 text-neutral-400 group-focus-within:text-blue-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
            </div>
            <input
              type="text"
              className="block w-full pl-16 pr-6 py-5 bg-neutral-900/60 border border-neutral-800 rounded-full text-lg text-white placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 backdrop-blur-xl transition-all shadow-xl shadow-black/50"
